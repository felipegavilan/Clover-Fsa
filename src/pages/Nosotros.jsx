        ...
        <div className="max-w-4xl mx-auto px-6 space-y-16">
          ...
          <section>
            ...
            <p className="text-lg text-gray-600 leading-relaxed text-center">
              ...
              encuentres eso que buscas, con atención personalizada y el
              respaldo de un equipo que elige cada prenda para vos.
            </p>
          </section>
          ...
          <section className="bg-gray-50 p-8 rounded-xl border border-gray-100">
            ...
            <p className="text-gray-600 mb-6">
              Te esperamos en nuestro local. Vení a conocer las mejores prendas
              y probate lo que más te guste.
            </p>
